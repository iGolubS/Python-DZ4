...
# Я так понял что здесь два задания в одном.
...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("dz4_1.txt", create_str(koef1))
write_file("dz4_2.txt", create_str(koef2))

# нахождение суммы многочлена

with open('dz4_1.txt', 'r') as data:
    st1 = data.readlines()
with open('dz4_2.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("dz4_res.txt", create_str(lst_new))
with open('dz4_res.txt', 'r') as data:
    st3 = data.readlines()
